...
document.getElementById('yessir').addEventListener('click', () => {
    alert('You got yourself a date! To further discuss details about the date,talk to the creator of this invitation. The most handsome and sweetest man on earth Mr.Mavige Rodique. ')
})
